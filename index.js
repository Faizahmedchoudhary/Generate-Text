...
const text = [
  ...
  I just told you! You've killed me! Fry! Quit doing the right thing, you jerk! Michelle, I don't regret this, but I both rue and lament it. Morbo can't understand his teleprompter because he forgot how you say that letter that's shaped like a man wearing a hat.`,
    ...
    `as it is brilliant! Your lyrics lack subtlety. You can't just havs it is brilliant! Your lyrics lack subtlety. You can't just have your characters annou`
  ];

submit = document.getElementById('submit');
howmanypara = document.getElementById('howmanypara');

submit.addEventListener("click" , function(e) {
    let amount = howmanypara.value ;
     amount = parseInt(amount);
    console.log(amount);

    // take the paragraph no and print the value ;
         generatetext = text[amount] ;


        document.getElementById('generate-content').innerHTML = generatetext ;

        if (amount > 10 ) {
            document.getElementById('generate-content').innerHTML = 'please enter value less than or equal to 10' ;
        }
